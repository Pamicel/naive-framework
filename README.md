...
I don't like PHP that much, don't read me as a Javascript diehard, but I believe PHP (pure PHP with no framework or library that is) enforces concepts that are pretty antiquated. I did not feel like spending my learning time on that. Moreover I had stumbled upon Vue a few months earlier, and the clarity and simplicity of it really struck me.
